  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-lg-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Logged as: <?php echo $user['email'] ?></a>
        </li>
        <li class="nav-item">
          <button type="button" class="btn btn-light shadow-sm" id="logoutBtn">Log out</button>
        </li>
      </ul>
    </div>
  </div>
